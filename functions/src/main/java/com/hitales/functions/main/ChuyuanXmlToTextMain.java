...
public class ChuyuanXmlToTextMain {
    ...
    private static List<String> forbidAnchorList = new ArrayList<>();
    static {
        forbidAnchorList.add("活动");
        forbidAnchorList.add("康复建议");
        forbidAnchorList.add("饮食指导");
        forbidAnchorList.add("出院后继续服用");
        forbidAnchorList.add("指导");
        forbidAnchorList.add("要及时来院就诊的情况");
        forbidAnchorList.add("康复指导");
        forbidAnchorList.add("殊饮食指导");
        forbidAnchorList.add("门诊复查");
        forbidAnchorList.add("随访及复诊");
        forbidAnchorList.add("用");
        forbidAnchorList.add("需要及时来我科就诊的情况");
        forbidAnchorList.add("动指导");
    }
    
    public static List<String> specialTextList = new ArrayList<>();
    static {
        specialTextList.add("死者姓名");
        specialTextList.add("性别");
        specialTextList.add("出生日期");
        specialTextList.add("年龄");
        specialTextList.add("婚否");
        specialTextList.add("身份证编号");
        specialTextList.add("入院时间");
        specialTextList.add("科别");
        specialTextList.add("病区");
        specialTextList.add("主治医师");
        specialTextList.add("住院医师");
        specialTextList.add("科 主诊医师");
        specialTextList.add("科主诊医师");
        specialTextList.add("讨论地点");
        specialTextList.add("主持人");
        specialTextList.add("参加讨论人员");
        specialTextList.add("经验教训");
        specialTextList.add("住院天数");
        specialTextList.add("死亡时间");
        specialTextList.add("姓名");
        specialTextList.add("记录者");
        specialTextList.add("手术日期");
    }
            ...
            for(int i = 0; i < fileList.size(); i++){
                ...
                while((line = bufferedReader.readLine()) != null){
                    ...
                    if(line.startsWith("<text")){
                        ...
                        if(!text.endsWith("：") && specialTextList.contains(text)){
                            text = text + "：";
                        }
                    ...
                    if(StringUtils.isNotEmpty(text) || bingchengqianming){
                        Matcher matcher = PatternUtil.STANDARD_ANCHOR_PATTERN.matcher(text);
                        if(matcher.find()){
                            String value  = matcher.group(1);
                            if(!forbidAnchorList.contains(value)){
